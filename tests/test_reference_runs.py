...
def test_mf5_ref_run_etsdrt(modelname='etsdrt',
    ...
    fun_test_reference_run(modelname,
                           os.path.join(test_example_dir, modelname,
                                        'inputref'),
                           mf5_exe,
                           test_hds=test_hds,
                           test_cbc=test_cbc,
...
def test_swt_ref_run_2_henry_1_classic_case1(modelname='seawat',
                                             test_hds=True,
                                             test_cbc=True,
                                             test_ucn=True,
                                             almost_equal=True):
...
def test_swt_ref_run_2_henry_2_classic_case2(modelname='seawat',
                                             test_hds=True,
                                             test_cbc=True,
                                             test_ucn=True,
                                             almost_equal=True):
...
def test_swt_ref_run_2_henry_3_VDF_no_Trans(modelname='seawat',
                                            test_hds=True,
                                            test_cbc=True,
                                            test_ucn=False,
                                            almost_equal=True):
...
def test_swt_ref_run_2_henry_4_VDF_uncpl_Trans(modelname='seawat',
                                               test_hds=True,
                                               test_cbc=True,
                                               test_ucn=False,
                                               almost_equal=True):
...
def test_swt_ref_run_2_henry_5_VDF_DualD_Trans(modelname='seawat',
                                               test_hds=True,
                                               test_cbc=True,
                                               test_ucn=True,
                                               almost_equal=True):
...
def test_swt_ref_run_2_henry_6_age_simulation(modelname='henry_mod',
                                              test_hds=True,
                                              test_cbc=True,
                                              test_ucn=True,
                                              almost_equal=True):
...
def test_swt_ref_run_3_elder(modelname='seawat',
                             test_hds=True,
                             test_cbc=True,
                             test_ucn=True,
                             almost_equal=True):
...
def test_swt_ref_run_4_hydrocoin(modelname='seawat',
                                 test_hds=True,
                                 test_cbc=True,
                                 test_ucn=True,
                                 almost_equal=True):
...
def test_swt_ref_run_6_rotation_1_symmetric(modelname='seawat',
                                            test_hds=True,
                                            test_cbc=True,
                                            test_ucn=True,
                                            almost_equal=True):
...
def test_swt_ref_run_6_rotation_2_asymmetric(modelname='seawat',
                                             test_hds=True,
                                             test_cbc=True,
                                             test_ucn=True,
                                             almost_equal=True):
